          ...
          <div class="about-agileinfo w3layouts">
               <div class="col-md-8 about-wthree-grids grid-top">
                    ...
                    <div class="about-w3agilerow">
                         ...
                         <div class="col-md-4 about-w3imgs">
                              <img src="{{ asset('public/user/images/p4.jpg')}}" alt=""  class="img-responsive zoom-img"/>
                         </div>
                         <div class="col-md-4 about-w3imgs">
                              <img src="{{ asset('public/user/images/p3.jpg') }}" alt=""  class="img-responsive zoom-img"/>
                         </div>
               ...
               <div class="col-md-4 about-wthree-grids">
                    ...
                    <div class="testi">
                         ...
                         <!--//End-slider-script -->
                         <script src="{{ asset('public/user/js/responsiveslides.min.js') }}"></script>
                          <script>
     ...
     <div class="container">
          ...
          <div class="team-agileitsinfo">
               <div class="col-md-3 about-team-grids">
                    <img src="{{ asset('public/user/images/t4.jpg') }}" alt=""/>
               ...
               <div class=" col-md-3 about-team-grids">
                    <img src="{{ asset('public/user/images/t2.jpg') }}" alt=""/>
                    <div class="team-w3lstext">
               ...
               <div class="col-md-3 about-team-grids">
                    <img src="{{ asset('public/user/images/t1.jpg') }}" alt=""/>
                    <div class="team-w3lstext">
               ...
               <div class="col-md-3 about-team-grids">
                    <img src="{{ asset('public/user/images/t3.jpg')}}" alt=""/>
                    <div class="team-w3lstext">
